			...
			<div class="content">
				<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10" style="">
					...
					<div class="card card-secondary" style="margin-left: 30px;">
						...
						<!-- form start -->
						<form class="form-inline" action="${base }/admin_contact_list"
							method="get">
								...
								<tbody>
									<c:forEach items="${contactsWithPaging.data}" var="contact"
										...
										<tr>
											...
											<td><i class="fas fa-barcode mr-2"></i>${contact.firstName }
												${contact.lastName }</td>
											...
											<td>
												<div style="width: 250px">${contact.message}</div>
											</td>

											<td><span style="font-size: 15px"
												id="status_${contact.id }"> <c:choose>
												...
												<button class="btn bg-gradient-success mr-1"
													...
													type="button"
													onclick="activeStatusSto('${base }', ${contact.id })">on</button>

												<button class="btn btn-danger mr-1"
													style="padding: 3px 6px 3px 6px; font-size: 12px"
													type="button"
													onclick="inActiveStatusSto('${base }', ${contact.id })">off</button></td>
