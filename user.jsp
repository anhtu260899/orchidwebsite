			...
			<div class="content">
				<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10" style="">
					...
					<div class="card card-secondary" style="margin-left: 30px;">
						...
						<sf:form modelAttribute="user" action="${base }/admin_user"
							method="post" enctype="multipart/form-data">
							<sf:hidden path="id" />
							<div class="card-body" style="">

								<div class="form-group mb-2">
									<label for="Roles">Roles (required)</label>
									<sf:select path="" name="roleUser" class="form-control"
										id="roles">
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Phone Number</label> <input
										value="${user.phone }" type="text" class="form-control"
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Address</label> <input
										value="${user.address }" type="text" class="form-control"
								...
								<div class="form-group ">
									<label for="exampleInputEmail1">PassWord</label> <input
										...
										path="password" id="password" name="password"
								...
								<div class="form-group ">
									<label for="exampleInputEmail1">Email</label> <input
										...
										path="email" id="email" name="email" placeholder="Enter email">
								</div>
								...
								<div class="mt-5">
									<a href="${base }/admin_user_list" class="btn btn-secondary"
